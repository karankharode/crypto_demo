import 'package:crypto_demo/utils/constants.dart';
...
class _ChartState extends State<Chart> {
  ...
  @override
  void initState() {
    dataAnimated = List.filled(widget.data.length, widget.initialData ?? widget.minData);
      ...
      child: LineChart(
        ...
        LineChartData(
          ...
          titlesData: FlTitlesData(
            ...
            rightTitles: AxisTitles(
              sideTitles: SideTitles(
                  ...
                  reservedSize: NumberFormat(widget.format).format(widget.minData).length * 11.0,
                  interval: widget.interval,
                  getTitlesWidget: (value, meta) {
                    String title = widget.horizontalLines.contains(value.toStringAsFixed(4))
          ...
          lineBarsData: [
            LineChartBarData(
              spots: [
                for (int i = 0; i < dataAnimated.length; i++) FlSpot(i.toDouble(), dataAnimated[i])
              ],
              isCurved: true,
